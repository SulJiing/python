 ...
 *				ex) NullPointException, ArithmeticException, illegalArgumentException
 *
 * 	* 예외처리
 ...
 * 				(checked exception -> unchecked exception으로 전환)
 * 	3. 예외 복구 : 배치 처리에서 주로 활용됨
 * 
 * 	custom exception 활용 구조. (throw)
 * 	1. 예외 클래스 정의(exrends Exception : checked, extends RuntimeException:unChecked)
 * 	2. throw new 예외생성자
 */
class ExceptionDesc {
