...
public class ProdUpdateController {
	...
	@GetMapping
	public String formUI(@RequestParam("what") String prodId, Model model) {
	...
	@PostMapping
	public String updateProcess(@Validated(UpdateGroup.class) @ModelAttribute("prod") ProdVO prod
