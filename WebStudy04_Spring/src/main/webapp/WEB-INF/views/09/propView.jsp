...
<form:form id="insertForm" modelAttribute="property" method="post" action="<%=request.getContextPath()%>/09/property" class="row">
 	<div class="col-auto">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form:form id="updateForm" modelAttribute="property">
